...
export default class Cart extends Component {
    ...
    getLowStocks(){
        axios.get("http://localhost:8000/getLowStock")
        .then(res => {
    ...
    transactNow(){
        axios.get("http://localhost:8000/getTransact")
        .then(res => {
    ...
    handleScanBarcode(event) {
        ...
        if (!!barcode) {
            axios
                .post("http://localhost:8000/getProduct", { barcode })
                .then(res => {
    ...
    handleSubmit(){
        ...
        if(cart.length > 0){
            axios.post("http://localhost:8000/cart_out",{
                cart : cart,
