                    ...
                    <div class="card">
                        ...
                        <div class="row">
                                ...
                                <div class="col-sm-3 float-right">
                                    <a href="/account/create" class="btn btn-success float-right "> <i class="fa fa-plus"></i> Add New Account </a>
                                </div>
                            </div>
                        ...
                        <table id="example1" class="table table-bordered table-striped text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$account->role}}</td>
                                    <td>{{$account->store->store_name}}</td>
                                    <td>
                                        <div class="d-flex flex-row justify-content-center">
                                        <div class="p-2"><a href="/account/{{$account->id}}" class="btn btn-primary"> <i class="fa fa-edit"></i> Edit</a></div>
                                        <div class="p-2"> 
